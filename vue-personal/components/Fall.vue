    ...
    <div class="home--wrapper">
      <div class="home__content">
        <section class="home__content__header">
          <div v-if="$props.searchCommitted === true" class="fall__day__wrapper">
            <div class="fall__day__toggle__container">
              <span class="fall__day__one__title">1 Day</span>
              <label class="fall__switch" for="checkbox">
                <input type="checkbox" id="fall-checkbox" @click="viewToggle" />
                <div class="fall__slider round"></div>
              </label>
              <span class="fall__day__five__title">5 Day</span>
            </div>
            <h1 class="fall__city">{{ weather.weatherData.city.name }}</h1>
            <ul v-if="viewStatus === 1" :class=" [ viewStatus < 3 ? 'one-day-list': 'five-day-list'] + ' fall__day__list'">
              <li class="fall__day__list__item">
                <h1 class="fall__day__date">{{ getWeatherMonth($props.weatherData.list[0].dt_txt) }} {{ getWeatherDay($props.weatherData.list[0].dt_txt) }}</h1>
                <div v-bind:class="weatherClass + ' fall__day__image'"></div>
                <p class="fall__day__temp--high">{{ Math.floor($props.weatherData.list[0].main.temp) }} &#8457;</p>
                <p class="fall__day__temp--low">{{ Math.floor($props.weatherData.list[0].wind.speed) }} mph</p>
              </li>
            </ul>
            <ul v-else-if="viewStatus === 5" :class=" [ viewStatus < 3 ? 'one-day-list': 'five-day-list'] + ' fall__day__list'">
              <li v-for="(day, index) in getFiveDay($props.weatherData.list)" v-bind:key="`day-${index}`"  class="fall__day__list__item">
                <div>
                  <h1 class="fall__day__date">{{ getWeatherMonth(day.dt_txt) }} {{ getWeatherDay(day.dt_txt) }}</h1>
                  <div v-bind:class="getWeatherClass(day.weather[0].id) + ' fall__day__image'"></div>
                  <p class="fall__day__temp--high">{{ Math.floor(day.main.temp) }} &#8457;</p>
                  <p class="fall__day__temp--low">{{ Math.floor(day.wind.speed) }} mph</p>
                </div>
              </li>
            </ul>
          </div>
