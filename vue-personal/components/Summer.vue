<template>
  <section class="slide slide-3 blog summer hidden-slide">
    <div class="home--wrapper">
      <div class="home__content">
        <section class="home__content__header">
          <div v-if="$props.searchCommitted === true" class="summer__day__wrapper">
            <div class="summer__day__toggle__container">
              <span class="summer__day__one__title">1 Day</span>
              <label class="summer__switch" for="checkbox">
                <input type="checkbox" id="summer-checkbox" @click="viewToggle" />
                <div class="summer__slider round"></div>
              </label>
              <span class="summer__day__five__title">5 Day</span>
            </div>
            <h1 class="summer__city">{{ weather.weatherData.city.name }}</h1>
            <ul v-if="viewStatus === 1" :class=" [ viewStatus < 3 ? 'one-day-list': 'five-day-list'] + ' summer__day__list'">
              <li class="summer__day__list__item">
                <h1 class="summer__day__date">{{ getWeatherMonth($props.weatherData.list[0].dt_txt) }} {{ getWeatherDay($props.weatherData.list[0].dt_txt) }}</h1>
                <div v-bind:class="weatherClass + ' summer__day__image'"></div>
                <p class="summer__day__temp--high">{{ Math.floor($props.weatherData.list[0].main.temp) }} &#8457;</p>
                <p class="summer__day__temp--low">{{ Math.floor($props.weatherData.list[0].wind.speed) }} mph</p>
              </li>
            </ul>
            <ul v-else-if="viewStatus === 5" :class=" [ viewStatus < 3 ? 'one-day-list': 'five-day-list'] + ' summer__day__list'">
              <li v-for="(day, index) in getFiveDay($props.weatherData.list)" v-bind:key="`day-${index}`"  class="summer__day__list__item">
                <div>
                  <h1 class="summer__day__date">{{ getWeatherMonth(day.dt_txt) }} {{ getWeatherDay(day.dt_txt) }}</h1>
                  <div v-bind:class="getWeatherClass(day.weather[0].id) + ' summer__day__image'"></div>
                  <p class="summer__day__temp--high">{{ Math.floor(day.main.temp) }} &#8457;</p>
                  <p class="summer__day__temp--low">{{ Math.floor(day.wind.speed) }} mph</p>
                </div>
              </li>
            </ul>
          </div>
...
@import '~/assets/scss/summer.scss';
